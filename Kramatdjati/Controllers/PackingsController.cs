...
namespace Kramatdjati.Controllers
{
    public class PackingsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PackingID,Size,JmlPerPacking")] Packing packing)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PackingID,Size,JmlPerPacking")] Packing packing)
        {
            if (ModelState.IsValid)
            {
