<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rptViewer.aspx.cs" Inherits="Kramatdjati.RPTReports.rptViewer" %>
    ...
    <form id="form1" runat="server">
        ...
        <div>
            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="100%">
                <LocalReport ReportPath="RPTReports\rptTesCetak.rdlc">
                </LocalReport>
            </rsweb:ReportViewer>
          </div>
